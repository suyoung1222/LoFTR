...
_CN.RESOLUTION = (32, 8) #(8, 2)  # options: [(8, 2), (16, 4)]
...
_CN.RESNETFPN.BLOCK_DIMS = [128, 196, 256, 256, 256] # [128, 196, 256]  # s1, s2, s3 
...
_CN.MATCH_COARSE = CN()
_CN.MATCH_COARSE.THR = 0.0 #0.2
_CN.MATCH_COARSE.BORDER_RM = 0 #2
...
_CN.MATCH_COARSE.TRAIN_COARSE_PERCENT = 1.0 #0.4  # training tricks: save GPU memory
