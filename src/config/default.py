...
_CN.LOFTR.MATCH_COARSE.THR = 0.0 #0.2
_CN.LOFTR.MATCH_COARSE.BORDER_RM = 0 #2
...
_CN.LOFTR.MATCH_COARSE.TRAIN_COARSE_PERCENT = 1.0 #0.2  # training tricks: save GPU memory
